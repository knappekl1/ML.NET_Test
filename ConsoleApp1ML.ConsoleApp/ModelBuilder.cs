...
namespace ConsoleApp1ML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\libor\Dropbox\RPA\NLP_with_Python\UPDATED_NLP_COURSE\TextFiles\smsspamcollection.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\libor\AppData\Local\Temp\MLVSTools\ConsoleApp1ML\ConsoleApp1ML.Model\MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Conversion.MapValueToKey("label", "label")
                                      ...
                                      .Append(mlContext.Transforms.Concatenate("Features", new[] { "message_tf", "length" }))
